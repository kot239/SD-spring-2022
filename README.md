...
В ином случае проходит по аргументам. Если аргумент - файл, то выводит его название.
Если аргумент - директория, то выводит ее содержимое.
Если в процессе прохода по аргументам файла или директории не существует - выводит сообщение об этом и продолжает проход.
