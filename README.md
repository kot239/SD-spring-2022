...
Принимает на вход 0 или 1 аргумент. 

Если аргументов нет - возвращает значение текущей директории к изначальному 
(то есть к директории, из которой была запущенна программа).

Если есть единственный аргумент (путь) - меняет значение текущей директории в соответствии с путем.
Если поменять не удалось (например, путь некорректный), то выводит сообщение об ошибке.

Если аргументов 2 или больше - выводит сообщение об ошибке.
